...
from arbitex.exceptions import ActivationError
from arbitex.views import ActivationView as BaseActivationView
from arbitex.views import RegistrationView as BaseRegistrationView
...
class RegistrationView(BaseRegistrationView):
    ...
    email_body_template = "arbitex/activation_email_body.txt"
    email_subject_template = "arbitex/activation_email_subject.txt"
    success_url = reverse_lazy("arbitex_complete")
