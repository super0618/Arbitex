...
from arbitex.backends.activation.views import (
    REGISTRATION_SALT,
    ActivationView,
)
...
@override_settings(ROOT_URLCONF="arbitex.backends.activation.urls")
class ActivationBackendViewTests(ActivationTestCase):
    ...
    def test_activation(self):
        ...
        self.assertRedirects(resp, reverse("arbitex_activation_complete"))
    ...
    def test_repeat_activation(self):
        ...
        self.assertTemplateUsed(resp, "arbitex/activation_failed.html")
    ...
    def test_activation_expired(self):
        ...
        self.client.post(reverse("arbitex_register"), data=self.valid_data)
